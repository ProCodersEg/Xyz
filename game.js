...
document.addEventListener("touchstart", (e) => {
  ...
  if (
    !gameStarted &&
    startButton.style.display !== "none" &&
    touchX >= startButton.offsetLeft &&
    touchX <= startButton.offsetLeft + startButton.offsetWidth &&
    touchY >= startButton.offsetTop &&
    touchY <= startButton.offsetTop + startButton.offsetHeight
  ) {
    startGame();
  }
